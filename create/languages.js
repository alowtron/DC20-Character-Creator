async function initialize() {
    ...
    document.getElementById('language2Level').value = characterInfo['language2_level']
    document.getElementById('language3').value = characterInfo['language3']
    document.getElementById('language3Level').value = characterInfo['language3_level']
...
function updateLanguages() {
    document.getElementById('languagePoints').innerHTML = languagePoints()
}
